"""HPE PCAI badge for sidebar - professional card design."""
...
def render_hpe_badge() -> None:
    """Render an HPE PCAI badge at the bottom of the sidebar."""
    ...
    try:
        ...
        if hero_path and hero_path.exists():
            ...
            hero_mime = guessed_mime or "image/png"
