...
EXAMPLE_PROMPT = {
    ...
    "animate-14B": {
        "prompt": "The person in the video performs natural movements and actions.",
        "video": "",
        "pose": "",
        "mask": "",
    },
...
def _parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="local_qwen",
        choices=["dashscope", "local_qwen", "openai"],
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="How many frames used for temporal guidance. Must be 1 or 5."
    )
    parser.add_argument(
        "--replace_flag",
        action="store_true",
    ...
    if args.use_prompt_extend:
        if args.prompt_extend_method == "dashscope":
            ...
            prompt_expander = QwenPromptExpander(
                ...
                is_vl=args.image is not None,
                device=rank)
        elif args.prompt_extend_method == "openai":
            prompt_expander = OpenAIPromptExpander(
                base_url=args.prompt_extend_model,
                task=args.task,
                is_vl=args.image is not None)
        else:
